...
**x-------------x-------------x-------------x-------------x-------------x-------------x**
## Project Description
This repository serves as a practical demonstration of the following in C language:
* Data-types used in C;
* How to intialize and declare variables;
* How to take input from user and print it using function such as scanf(), printf() etc;
